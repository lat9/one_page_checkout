...
if (isset($_POST['action']) && ($_POST['action'] == 'register')) {
    ...
    if ($error) {
        ...
        $sql_data_array = array(
            ...
            array('fieldName' => 'entry_firstname', 'value' => $firstname, 'type' => $db_string_type),
            array('fieldName' => 'entry_lastname', 'value' => $lastname, 'type' => $db_string_type),
            array('fieldName' => 'entry_street_address', 'value' => '', 'type' => $db_string_type),
            array('fieldName' => 'entry_postcode', 'value' => '', 'type' => $db_string_type),
            array('fieldName' => 'entry_city', 'value' => '', 'type' => $db_string_type),
